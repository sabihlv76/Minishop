...
function AppContent() {
  ...
  useEffect(() => {
    ...
    async function loadRemoteStore() {
      try {
        ...
        console.warn(
          'Remote store unavailable. Changes will not persist to database until MONGODB_URI is configured.',
          error
        );
      }
    }
  ...
  const handleRefreshProducts = async () => {
    try {
      ...
      console.warn('Could not refresh from Mongo Atlas, falling back to defaults.', error);
